"use strict";var hamburger=document.querySelector(".hamburger"),menu=document.querySelector(".navigation__list");hamburger.addEventListener("click",function(){menu.classList.toggle("navigation__list_active"),hamburger.classList.toggle("hamburger__active")});
